        ...
        <Card title="Muito obrigado">
          <>
            ...
            <p className="margin-top">
              ...
              que a confirmação pode levar até 3 dias ulteis Após a aprovação do
              pagamento enviaremos um E-mail contendo o codigo de ativação do
              jogo.
            </p>
            <p className="margin-top">
              Se você optou pelo pagamento com cartão de credito a liberação do
              codigo de ativação ocorrera após a aprovação da transação pela
              operadora don cartão. Você recebera o codigo no E-mail cadastrado
              em nossa loja.
            </p>
            <p className="margin-top">
              Pedimos que verifique sua caixa de entrada e a pasta de spam para
              garantir que receba nossa comunicação. Caso tenha alguma duvida ou
              necessite de mais informações por favor, entre em contato atraves
              dos nossos canais de atendimento ao cliente
            </p>
            <p className="margin-top">
              ...
              <div className="margin-top">
                {payWithCard ? (
                  <>
                    ...
                    <S.Row marginTop="24px">
                      ...
                      <S.InputGroup maxWidth="123px">
                        <label htmlFor="expiresMonth">Mes d expiração</label>
                        <InputMask
                          type="text"
                          id="expiresMonth"
                          name="expiresMonth"
                  ...
                  <p>
                    ...
                    que a confirmação pode levar até 3 ulteis, devidoaos prazos
                    estabelecidos pelas instituições financeiras. Portanto, a
                    liberação do codigo de ativação do jogo adquirido ocorrerá
